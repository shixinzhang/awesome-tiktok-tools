...
- [Hook & Script Libraries](#hook--script-libraries)
...
- [TokTranscript](https://toktranscript.com/?utm_source=github_awesome&utm_campaign=awesome_list) - AI TikTok transcription with viral breakdowns and 100+ language translation.
- [Submagic](https://www.submagic.co/) - Auto-captions and short video editing for creators.
- [Captions](https://www.captions.ai/) - AI-powered captions and subtitles for short-form video.
- [VEED.io](https://www.veed.io/) - Browser-based video editor with automatic subtitle generation.
- [Riverside Transcription](https://riverside.fm/transcription) - Transcription with speaker labels for podcasters and creators.
...
- [CapCut](https://www.capcut.com/) - TikTok's first-party video editor for desktop, mobile, and web.
- [Descript](https://www.descript.com/) - Edit video by editing the transcript, plus AI overdub.
- [Kapwing](https://www.kapwing.com/) - Collaborative online editor with auto-captions and subtitles.
- [Canva](https://www.canva.com/) - Drag-and-drop video templates sized for TikTok and Reels.
...
- [Exolyt](https://exolyt.com/) - TikTok analytics with profile, hashtag, and competitor benchmarks.
- [Pentos](https://pentos.co/) - Profile, hashtag, and song tracking for TikTok and Instagram.
- [Tokchart](https://tokchart.com/) - TikTok creator and hashtag charts with historical data.
...
- [TikTok Creative Center](https://ads.tiktok.com/business/creativecenter) - Official TikTok hashtag, song, and creative inspiration explorer.
...
- [Buffer](https://buffer.com/) - Multi-platform social scheduler with TikTok video support.
- [Hootsuite](https://www.hootsuite.com/) - Social media management with TikTok scheduling and analytics.
- [Sprout Social](https://sproutsocial.com/) - Enterprise social management with TikTok publishing and reporting.
...
- [TikTok Shop Seller Center](https://seller-us.tiktok.com/) - Official storefront and order management for TikTok Shop sellers.
- [TikTok Creator Marketplace](https://www.tiktok.com/business/en/solutions/creator-marketplace) - TikTok's first-party platform connecting brands with creators.
- [Shopify TikTok](https://shopify.com/tiktok) - Shopify integration for selling and tracking via TikTok Shop.
- [Impact](https://impact.com/) - Partnership automation covering affiliates, influencers, and referrals.
- [Skimlinks](https://www.skimlinks.com/) - Automatic affiliate-link conversion for content sites.
- [Aspire](https://www.aspire.io/) - Influencer marketing platform for creator discovery and campaign management.
- [Modash](https://www.modash.io/) - Creator search and influencer analytics for TikTok, Instagram, and YouTube.
- [Heepsy](https://www.heepsy.com/) - Influencer search with audience location and engagement filters.
- [Upfluence](https://www.upfluence.com/) - Influencer marketing platform with creator CRM and payments.
- [Grin](https://grin.co/) - Creator management platform for direct-to-consumer brands.
- [Klear](https://klear.com/) - Influencer marketing and analytics with TikTok creator data.
- [CreatorIQ](https://creatoriq.com/) - Enterprise creator lifecycle management across major platforms.

## API & Developer Tools

- [TikTok for Developers](https://developers.tiktok.com/) - Official TikTok API platform including Display API and Login Kit.
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - Command-line downloader supporting TikTok and hundreds of other sites.
...
- [TikTok Newsroom](https://newsroom.tiktok.com/) - Product, policy, and industry updates direct from TikTok.
- [Later Blog — TikTok](https://later.com/blog/category/tiktok/) - Tactical TikTok marketing posts updated regularly.
- [Buffer Library — TikTok](https://buffer.com/library/category/tiktok/) - Buffer's TikTok strategy and case-study collection.
...
- [sindresorhus/awesome](https://github.com/sindresorhus/awesome) - The parent awesome list with thousands of curated lists.
